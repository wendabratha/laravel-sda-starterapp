            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title ">{{ __('Buat Data Kabupaten') }}</h4>
                    </div>
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'admin.kabupaten.store' , 'class' => 'form-horizontal', 'files' => true]) !!}

                        @include ('admin::dashboard.kabupaten.form', ['formMode' => 'create'])
