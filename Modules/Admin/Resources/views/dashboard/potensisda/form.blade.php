...
<div class="form-group row">
    ...
    <div class="col-sm-7">
        {!! Form::file('image', null, ['class' => 'form-control ' . ($errors->has('image') ? ' is-invalid' : ''), 'required' => false]) !!}
...
<div class="form-group row">
    ...
    <div class="col-sm-7">
        {!! Form::file('video', null, ['class' => 'form-control ' . ($errors->has('video') ? ' is-invalid' : ''), 'required' => false]) !!}
