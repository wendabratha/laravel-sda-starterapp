...
<head>
    ...
    <link href="{{ asset('static-admin/css/jquery.fancybox.css') }}" rel="stylesheet">
    @stack('styles')
</head>
<body class="{{ $class ?? '' }}">
...
<script defer src="{{ asset('static-admin/js/jquery.fancybox.js') }}"></script>
<script defer src="{{ asset('static-admin/js/jquery.fancybox.pack.js') }}"></script>
@stack('scripts')
<script>
