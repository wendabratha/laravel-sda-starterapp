...
use Modules\Admin\Http\Controllers\Dashboard\KategoriController;

use Modules\Admin\Http\Controllers\Dashboard\ProvinsiController;
use Modules\Admin\Http\Controllers\Dashboard\KabupatenController;
use Modules\Admin\Http\Controllers\Dashboard\KecamatanController;
use Modules\Admin\Http\Controllers\Dashboard\KelurahanController;

use Modules\Admin\Http\Controllers\Dashboard\PotensisdaController;
use Modules\Admin\Http\Controllers\Dashboard\WebgisController;
...
Route::name('admin.')->prefix('admin')->middleware(['authAdmin', 'replaceGuard'])->group(function() {
    ...
    Route::resource('potensisda', PotensisdaController::class);
